            ...
            <div class="row align-items-center justify-content-between g-5">
                <div class="col-lg-6">
                    <div class="image-holder mb-4 jarallax">
                        <img src="{{asset('assets/images/single-image1.jpg')}}" alt="single" class="img-fluid jarallax-img">
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item1.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item2.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                                    <div class="cart-concern">
                                        <h3 class="card-title text-uppercase pt-3 text-primary">
                            ...
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item3.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                                    <div class="cart-concern">
                                        <h3 class="card-title text-uppercase pt-3 text-primary">
                            ...
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item4.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                                    <div class="cart-concern">
                                        <h3 class="card-title text-uppercase pt-3 text-primary">
                            ...
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item5.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                                    <div class="cart-concern">
                                        <h3 class="card-title text-uppercase pt-3 text-primary">
                                            <a href="single-product.html" class="text-primary">Black Sofa Set</a>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card image-zoom-effect link-effect d-flex flex-wrap">
                                    <div class="image-holder">
                                        <img src="{{asset('assets/images/product-item6.jpg')}}" alt="product-item" class="product-image img-fluid">
                                    </div>
                                    <div class="cart-concern">
                                        <h3 class="card-title text-uppercase pt-3 text-primary">
                                            <a href="single-product.html" class="text-primary">Minimal Sofa</a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide overflow-hidden">
                            <div class="product-card">
                                ...
                                <div class="image-overlay position-relative">
                                    <div class="product-image">
                                        <img src="{{asset('assets/images/product-item7.jpg')}}" alt="product-item" class="product-image img-fluid">
                        ...
                        <div class="swiper-slide overflow-hidden">
                            <div class="product-card">
                                ...
                                <div class="image-overlay position-relative">
                                    <div class="product-image">
                                        <img src="{{asset('assets/images/product-item8.jpg')}}" alt="product-item" class="product-image img-fluid">
            ...
            <div class="row g-3 post-grid">
                    ...
                    <div class="card-item">
                        <div class="card border-0 bg-transparent">
                            <div class="card-image">
                                <img src="{{asset('assets/images/post-item1.jpg')}}" alt="" class="post-image img-fluid">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                    <div class="card-item">
                        <div class="card border-0">
                            <div class="card-image">
                                <img src="{{asset('assets/images/post-item2.jpg')}}" alt="" class="post-image img-fluid">
                            </div>
                        </div>
                        <div class="card-body p-0 mt-4">
                            <h3 class="card-title text-uppercase">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                    <div class="card-item">
                        <div class="card border-0">
                            <div class="card-image">
                                <img src="{{asset('assets/images/post-item3.jpg')}}" alt="" class="post-image img-fluid">
                            </div>
                        </div>
                        <div class="card-body p-0 mt-4">
                            <h3 class="card-title text-uppercase">
    ...
    <section id="brand-collection" class="padding-small border-top border-bottom overflow-hidden margin-large mb-0">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                <a href="#"><img src="{{asset('assets/images/brand-logo-1.svg')}}" alt="brand"></a>
                <a href="#"><img src="{{asset('assets/images/brand-logo-2.svg')}}" alt="brand"></a>
                <a href="#"><img src="{{asset('assets/images/brand-logo-3.svg')}}" alt="brand"></a>
                <a href="#"><img src="{{asset('assets/images/brand-logo-4.svg')}}" alt="brand"></a>
                <a href="#"><img src="{{asset('assets/images/brand-logo-5.svg')}}" alt="brand"></a>
            </div>
        </div>
    </section>
